...
{
    partial class FormAtualizarFornecedor
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            BtnAtualizarFornecedor = new Button();
            ChkAtualizarEndereco = new CheckBox();
            ...
            // 
            BtnAtualizarFornecedor.BackColor = SystemColors.ControlLight;
            BtnAtualizarFornecedor.Font = new Font("Segoe UI Variable Display Semib", 16F, FontStyle.Bold);
            BtnAtualizarFornecedor.Location = new Point(4, 336);
            BtnAtualizarFornecedor.Name = "BtnAtualizarFornecedor";
            BtnAtualizarFornecedor.Size = new Size(778, 55);
            BtnAtualizarFornecedor.TabIndex = 15;
            BtnAtualizarFornecedor.Text = "Atualizar";
            BtnAtualizarFornecedor.UseVisualStyleBackColor = false;
            BtnAtualizarFornecedor.Click += BtnAtualizarFornecedor_Click;
            // 
            // ChkAtualizarEndereco
            // 
            ChkAtualizarEndereco.Location = new Point(5, 144);
            ChkAtualizarEndereco.Name = "ChkAtualizarEndereco";
            ChkAtualizarEndereco.Size = new Size(151, 24);
            ChkAtualizarEndereco.TabIndex = 0;
            ChkAtualizarEndereco.Text = "Atualizar endereço";
            ChkAtualizarEndereco.CheckedChanged += ChkAtualizarEndereco_CheckedChanged_1;
            // 
            // FormAtualizarFornecedor
            // 
            AutoScaleDimensions = new SizeF(7F, 17F);
            AutoScaleMode = AutoScaleMode.Font;
            BackColor = SystemColors.Control;
            ClientSize = new Size(784, 394);
            Controls.Add(ChkAtualizarEndereco);
            Controls.Add(BtnAtualizarFornecedor);
            ...
            Name = "FormAtualizarFornecedor";
            Text = "FastBox - Atualizar fornecedores";
            Load += FormAtualizarFornecedor_Load;
        ...
        private CheckBox ChkAtualizarEndereco;
    }
}